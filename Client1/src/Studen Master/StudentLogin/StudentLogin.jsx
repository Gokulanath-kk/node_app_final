...
import { AlertCircle, EyeClosed } from 'lucide-react';
        ...
        >
            ...
            <div className="flex-grow flex flex-col sm:flex-row items-center justify-center px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 ">
                ...
                <div className="w-full max-w-2xl mx-auto py-8 lg:py-0 px-20 xl:-mt-20 lg:-mt-20 md:-mt-20 ">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 ">
                        Welcome Back!
                    </h1>
                    <p className="text-base sm:text-lg mb-6 md:mb-8 text-transparent bg-clip-text bg-gradient-to-l from-purple-600 to-pink-600">
