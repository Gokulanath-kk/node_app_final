    ...
    return (
        ...
        >
            ...
            <div className="flex-grow flex flex-col md:flex-row items-center justify-center px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24">
                ...
                <div className="w-full md:w-1/2 text-center md:text-justify mb-8 md:mb-0 md:pr-8 lg:pr-16">
                    <h2 className="font-unbounded text-xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-4 sm:mb-5 text-gray-800 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 ">
                    Direction to Excellence
                    </h2> 
                    <p className="font-sans text-sm sm:text-sm md:text-lg text-slate-600 lg:tracking-wider xl:leading-relaxed md:tracking-wider text-justify sm:wider-sm">
