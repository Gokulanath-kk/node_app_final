...
const StudentFeedBack = () => {
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-3 p-6 sm:p-6 md:p-8 z-10">
            ...
            <div className="flex-grow flex flex-col md:flex-row items-center justify-center px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24">
                <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0 md:pr-8 lg:pr-16">
                    <h2 className="font-sans text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-4 sm:mb-5 text-gray-800 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">
                    Share Your Feedback
                    </h2>
                    <p className="font-sans text-sm sm:text-base md:text-lg text-slate-600 tracking-wider leading-relaxed text-justify">
                    Your experience matters to us! By sharing your thoughts, you’re helping us chart a better course for future journeys. Your feedback acts as our compass, guiding improvements and shaping the way forward. Take a moment to steer us in the right direction and make our next steps even better. Let’s navigate success together!
